...
public final class FCL_definition {
	public final static String memberShipFunctions1 = String.join("\n"
			...
			, "END_FUZZIFY"
			, "FUZZIFY app_priority"
			, " TERM normal   := (0.0,1) (0.5,1) (0.7,0);"
			, " TERM elevated := (0.4,0) (0.7,1) (0.85,0);"
			, " TERM critical := (0.75,0) (0.9,1) (1.0,1);"
			, "END_FUZZIFY"
	...
	public final static String fclDefinition1 = String.join("\n"
			...
			, " RULE 82 : IF app_priority IS critical  AND delay_sensitivity IS high THEN offload_decision IS edge;"
			, " RULE 83 : IF app_priority IS elevated AND avg_edge_util IS medium AND wan_bw IS medium THEN offload_decision IS edge;"
			, " RULE 84 : IF app_priority IS elevated AND avg_edge_util IS medium AND wan_bw IS medium THEN offload_decision IS edge;"
			, "END_RULEBLOCK"
			, "END_FUNCTION_BLOCK"
	);
	...
	public final static String fclDefinition2 = String.join("\n"
			...
			, " RULE 28 : IF app_priority IS critical THEN offload_decision IS nearest_edge;"
			, "END_RULEBLOCK"
			, "END_FUNCTION_BLOCK"
	);
